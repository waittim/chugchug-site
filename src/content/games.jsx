...
export const GAMES = [
  ...
  },
  {
    ...
    color: 'bg-[#FDA4AF]',
    icon: <MessagesSquare size={32} className="text-black" />,
    desc: { zh: '让你们深入了解对方', 'zh-Hant': '讓你們深入了解對方', en: 'Get to know each other on a deeper level' },
    rules: {
  ...
  },
  {
    ...
    color: 'bg-[#F97316]',
    icon: <Frown size={32} className="text-black" />,
    desc: { zh: '别戳中会发怒的老头！', 'zh-Hant': '別戳中會發怒的老頭！', en: "Don't poke the angry old man!" },
    rules: {
      zh: '屏幕上会出现一群老头。\n轮流选择，避免戳中会发怒的老头。\n戳中发怒老头的接受惩罚。',
      'zh-Hant': '螢幕上會出現一群老頭。\n輪流選擇，避免戳中會發怒的老頭。\n戳中發怒老頭的接受懲罰。',
